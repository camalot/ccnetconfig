...
namespace CCNetConfig.Core.Components
{
    ...
    public class InstanceTreeNodeAttribute
        : Attribute
    {
        #region Constructors
        /// <summary>
        /// Instantiates a new <see cref="InstanceTreeNodeAttribute"/>.
        /// </summary>
        ...
        public InstanceTreeNodeAttribute(Type itemType, string property, string nodeName)
        {
            ItemType = itemType;
            NodeName = nodeName;
            Property = property;
        ...
        /// <param name="itemType">The type of item the node will work with.</param>
        /// <param name="property">The property this node is based on.</param>
        public InstanceTreeNodeAttribute(Type itemType, string property)
        ...
        #region ChangeMenuText
        /// <summary>
        /// The text to use in the change menu.
        /// </summary>
        public string ChangeMenuText { get; set; }
        #endregion
        #endregion
    }
}
