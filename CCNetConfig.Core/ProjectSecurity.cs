...
{
    /// <summary>
    /// Exposes the security settings for a project.
    /// </summary>
    [MinimumVersion("1.5")]
    [ReflectorName("nullProjectSecurity")]
        ...
        : ICloneable, INotifyPropertyChanged, ICCNetObject
    {
        ...
        /// </summary>
        [Description("The type of project security.")]
        [DisplayName("(Type)")]
        ...
        {
            ProjectSecurity newValue = new ProjectSecurity();
            CopyTo(newValue);
            return newValue;
        }
        #endregion
        ...
        protected void CopyTo(ProjectSecurity value)
        {
            value.type = Type;
        }
        #endregion
