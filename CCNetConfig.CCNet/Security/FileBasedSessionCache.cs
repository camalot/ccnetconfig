...
namespace CCNetConfig.CCNet.Security
{
        ...
        : SecurityCache
    {
        #region Constructors
        /// <summary>
        /// Start a new instance of a <see cref="FileBasedSessionCache"/>.
        /// </summary>
        ...
        {
            FileBasedSessionCache newValue = new FileBasedSessionCache();
            CopyTo(newValue);
            return newValue;
        }
        #endregion
        ...
        protected virtual void CopyTo(FileBasedSessionCache value)
        {
            base.CopyTo(value);
